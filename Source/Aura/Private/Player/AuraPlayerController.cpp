...
void AAuraPlayerController::AbilityInpuyTagReleased(FGameplayTag InputTag)
{
...
void AAuraPlayerController::SetupInputComponent()
{
	...
	AuraInputComponent->BindAbilityActions(InputConfig, this, &ThisClass::AbilityInputTagPressed, &ThisClass::AbilityInpuyTagReleased, &ThisClass::AbilityInputTagHeld);
}
